function buynow() {
  ...
  function handleScroll() {
    ...
    if (currentSectionIndex !== -1) {
        ...
        if (currentLink) {
            ...
            document.title = "Serg's Website | IT | " + currentLink.textContent;
        }
    }
  }
  ...
  document.getElementById("homeButton").addEventListener("click", function(event) {
    ...
    handleLinkClick("homeButton", "Serg's Website | IT | Pagina Iniziale");
  });
  
  document.getElementById("aboutButton").addEventListener("click", function(event) {
    event.preventDefault();
    handleLinkClick("aboutButton", "Serg's Website | IT | Chi Siamo");
  });
  
  document.getElementById("servicesButton").addEventListener("click", function(event) {
    event.preventDefault();
    handleLinkClick("servicesButton", "Serg's Website | IT | Servizi");
  });
  ...
  document.getElementById("contactButton").addEventListener("click", function(event) {
    ...
    setTimeout(function() {
        handleLinkClick("contactButton", "Serg's Website | IT | Contatti");
  ...
  buyNowButton.addEventListener("click", function() {
      ...
      document.title = "Serg's Website | IT | Acquista Ora";
