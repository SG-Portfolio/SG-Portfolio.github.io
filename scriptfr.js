...
function handleScroll() {
  ...
  if (currentSectionIndex !== -1) {
      ...
      if (currentLink) {
          ...
          document.title = "Serg's Website | FR | " + currentLink.textContent;
      }
  }
}
...
document.getElementById("homeButton").addEventListener("click", function(event) {
  ...
  handleLinkClick("homeButton", "Serg's Website | FR | Accueil");
});

document.getElementById("aboutButton").addEventListener("click", function(event) {
  event.preventDefault();
  handleLinkClick("aboutButton", "Serg's Website | FR | À propos");
});

document.getElementById("servicesButton").addEventListener("click", function(event) {
  event.preventDefault();
  handleLinkClick("servicesButton", "Serg's Website | FR | Services");
});
...
document.getElementById("contactButton").addEventListener("click", function(event) {
  ...
  setTimeout(function() {
      handleLinkClick("contactButton", "Serg's Website | FR | Contact");
...
buyNowButton.addEventListener("click", function() {
    ...
    document.title = "Serg's Website | FR | Acheter Maintenant.";
