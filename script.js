...
function handleScroll() {
    ...
    if (currentSectionIndex !== -1) {
        ...
        if (currentLink) {
            ...
            document.title = "Serg's Website | EN | " + currentLink.textContent;
        }
    }
}
...
document.getElementById("homeButton").addEventListener("click", function(event) {
    ...
    handleLinkClick("homeButton", "Serg's Website | EN | Home");
});

document.getElementById("aboutButton").addEventListener("click", function(event) {
    event.preventDefault();
    handleLinkClick("aboutButton", "Serg's Website | EN | About");
});

document.getElementById("servicesButton").addEventListener("click", function(event) {
    event.preventDefault();
    handleLinkClick("servicesButton", "Serg's Website | EN | Service");
});
...
document.getElementById("contactButton").addEventListener("click", function(event) {
    ...
    setTimeout(function() {
        handleLinkClick("contactButton", "Serg's Website | EN | Contact");
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    // Code for language selector overlay goes here
});
document.addEventListener("DOMContentLoaded", function() {
    var cookieConsent = document.getElementById("cookieConsent");
    var languageSubmit = document.getElementById("languageSubmit");
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  buyNowButton.addEventListener("click", function() {
      ...
      document.title = "Serg's Website | EN | Buy Now";
