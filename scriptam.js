function buynow() {
  ...
  function handleScroll() {
    ...
    if (currentSectionIndex !== -1) {
        ...
        if (currentLink) {
            ...
            document.title = "Serg's Website | AM | " + currentLink.textContent;
        }
    }
  }
  ...
  document.getElementById("homeButton").addEventListener("click", function(event) {
    ...
    handleLinkClick("homeButton", "Serg's Website | AM | Գլխավոր");
  });
  
  document.getElementById("aboutButton").addEventListener("click", function(event) {
    event.preventDefault();
    handleLinkClick("aboutButton", "Serg's Website | AM | Մեր մասին");
  });
  
  document.getElementById("servicesButton").addEventListener("click", function(event) {
    event.preventDefault();
    handleLinkClick("servicesButton", "Serg's Website | AM | Ծառայություններ");
  });
  ...
  document.getElementById("contactButton").addEventListener("click", function(event) {
    ...
    setTimeout(function() {
        handleLinkClick("contactButton", "Serg's Website | AM | Կապ");
  ...
  buyNowButton.addEventListener("click", function() {
      ...
      document.title = "Serg's Website | AM | Գնել Հիմա";
