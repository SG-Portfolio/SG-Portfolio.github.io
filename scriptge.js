...
function handleScroll() {
  ...
  if (currentSectionIndex !== -1) {
      ...
      if (currentLink) {
          ...
          document.title = "Serg's Website | GE | " + currentLink.textContent;
      }
  }
}
...
document.getElementById("homeButton").addEventListener("click", function(event) {
  ...
  handleLinkClick("homeButton", "Serg's Website | GE | Startseite");
});

document.getElementById("aboutButton").addEventListener("click", function(event) {
  event.preventDefault();
  handleLinkClick("aboutButton", "Serg's Website | GE | Über uns");
});

document.getElementById("servicesButton").addEventListener("click", function(event) {
  event.preventDefault();
  handleLinkClick("servicesButton", "Serg's Website | GE | Dienstleistungen");
});
...
document.getElementById("contactButton").addEventListener("click", function(event) {
  ...
  setTimeout(function() {
      handleLinkClick("contactButton", "Serg's Website | GE | Kontakt");
...
buyNowButton.addEventListener("click", function() {
    ...
    document.title = "Serg's Website | GE | Jetzt kaufen";
